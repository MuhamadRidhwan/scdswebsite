...
export const SubmissionGuideline = () => (
  ...
  <Helmet>
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/scds2010/home">Home</a></li>
    ...
    <p style={{ textAlign:'justify'}}>
      SCDS2020 accepts only high-quality papers for its conference proceedings, which are subject to a thorough &amp; 
      ...
      research on one of the SCDS2020 topics of interest. All submissions will be handled electronically; detailed submission instructions will be provided 
      on the conference homepage. The acceptance rate for SCDS2019 was 38%. </p>
    ...
    <p>Submission deadline: 31st May 2020</p>

    <h2>Accepted Paper</h2>
    <p style={{ textAlign:'justify'}}>
      Proceedings of SCDS2020 will be published in Springer&#39;s CCIS series Communications in Computer and Information Science by Springer.
    </p>
    ...
    <h2>Publications</h2>
    <p style={{ textAlign:'justify'}}>
    All accepted and registered papers of SCDS2020 will be submitted to be indexed in the renowned series of &quot;Communications in Computer and 
